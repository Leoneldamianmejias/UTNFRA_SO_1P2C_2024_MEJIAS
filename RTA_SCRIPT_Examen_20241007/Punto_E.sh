#!/bin/bash
echo "Generando Informacion al Filtro basico..."
...
echo "Chassis Information" >> /home/vagrant/repogit/UTNFRA_SO_1P2C_2024_MEJIAS/RTA_ARCHIVOS_Examen_20241007/Filtro_Basico.txt
